...
TREES = {
    'oak': {'minimap rgb': 'green4'}, 
    'evergreen': {'minimap rgb': 'darkgreen'}, 
    'bare': {'minimap rgb': 'saddlebrown'}, 
    'stump': {'minimap rgb': 'saddlebrown'}, 
    'fir 0': {'minimap rgb': 'palegreen4'}, 
    'fir 1': {'minimap rgb': ''}, 
    'fruit': {'minimap rgb': ''}, 
    'maple 0': {'minimap rgb': ''}, 
    'maple 1': {'minimap rgb': ''},
...
SURFACE_TERRAIN = {
    'small rock': {'hardness': SOLID_TILES['stone']['hardness'] // 2, 'minimap rgb': 'azure4'}, 
    'large rock': {'hardness': SOLID_TILES['stone']['hardness'] * 2, 'minimap rgb': 'azure4'}, 
    'small mushroom': {'hardness': 100, 'minimap rgb': 'cornsilk2'}, 
    'large mushroom': {'hardness': 150, 'minimap rgb': 'red3'}, 
    'lilypad': {'hardness': 0}, 
    'cactus': {'hardness': 150, 'minimap rgb': 'lime'}, 
    'snow': {'hardness': 100, 'minimap rgb': 'snow'}
}
for b in BIOMES: 
...
TILES_REMOVABLE_WITHOUT_PICKAXE = SURFACE_TERRAIN.keys() | {'dirt', 'sand', 'snow', 'ice', 'clay'}

PLACEABLE_TILES = SOLID_TILES.keys() | SURFACE_TERRAIN.keys() # TODO: add wood blocks once they can be crafted

LIQUIDS = {
    'water': {'minimap rgb': 'blue'}, 
    'lava': {'minimap rgb': 'orangered'}, 
    'honey': {'minimap rgb': 'goldenrod2'},
}

ALL_TILES = set(REMOVABLE_TILES) | ELEVATIONS | LIQUIDS.keys()
