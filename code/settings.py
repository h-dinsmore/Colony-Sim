...
BIOMES = {
    'tundra': {
        ...
        'z layers': {
            ...
            0.8: {'stone': (0.0, 0.35), 'obsidian': (0.35, 0.55), 'iron': (0.55, 0.75), 'coal': (0.75, 0.88), 'silver': (0.88, 0.97), 'sapphire': (0.97, 1.0)},
            1.0: {'stone': (0.0, 0.3), 'ice': (0.3, 0.5), 'fossil': (0.5, 0.65), 'iron': (0.65, 0.8), 'silver': (0.8, 0.95), 'sapphire': (0.95, 1.0)}
        }
    },
    ...
    'taiga': {
        ...
        'z layers': {
            ...
            0.8: {'stone': (0.0, 0.35), 'coal': (0.35, 0.6), 'amber': (0.6, 0.75), 'iron': (0.75, 0.9), 'silver': (0.9, 0.98), 'emerald': (0.98, 1.0)},
            1.0: {'stone': (0.0, 0.35), 'coal': (0.35, 0.55), 'amber': (0.55, 0.7), 'fossil': (0.7, 0.82), 'iron': (0.82, 0.92), 'silver': (0.92, 0.98), 'emerald': (0.98, 1.0)}
        }
    },
    ...
    'forest': {
        ...
        'z layers': {
            ...
            0.8: {'stone': (0.0, 0.45), 'coal': (0.45, 0.65), 'iron': (0.65, 0.85), 'amber': (0.85, 0.95), 'emerald': (0.95, 1.0)},
            1.0: {'stone': (0.0, 0.45), 'coal': (0.45, 0.65), 'amber': (0.65, 0.8), 'iron': (0.8, 0.92), 'emerald': (0.92, 1.0)}
        }
    },
    ...
    'plains': {
        ...
        'z layers': {
            ...
            0.8: {'stone': (0.0, 0.5), 'fossil': (0.5, 0.68), 'iron': (0.68, 0.88), 'coal': (0.88, 0.97), 'silver': (0.97, 1.0)},
            1.0: {'stone': (0.0, 0.45), 'clay': (0.45, 0.65), 'fossil': (0.65, 0.82), 'iron': (0.82, 0.94), 'silver': (0.94, 1.0)}
        }
    },
    ...
    'desert': {
        ...
        'z layers': {
            ...
            0.8: {'stone': (0.0, 0.35), 'copper': (0.35, 0.6), 'gold': (0.6, 0.82), 'topaz': (0.82, 0.95), 'ruby': (0.95, 1.0)},
            1.0: {'stone': (0.0, 0.25), 'copper': (0.25, 0.5), 'fossil': (0.5, 0.65), 'gold': (0.65, 0.82), 'topaz': (0.82, 0.94), 'ruby': (0.94, 1.0)}
        }
    },
    ...
    'jungle': {
        ...
        'z layers': {
            ...
            0.8: {'stone': (0.0, 0.4), 'coal': (0.4, 0.6), 'copper': (0.6, 0.8), 'emerald': (0.8, 0.94), 'amethyst': (0.94, 1.0)},
            1.0: {'stone': (0.0, 0.3), 'copper': (0.3, 0.5), 'gold': (0.5, 0.68), 'emerald': (0.68, 0.82), 'amethyst': (0.82, 0.92), 'ruby': (0.92, 1.0)}
        }
    },
}
