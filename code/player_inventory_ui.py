...
class PlayerInventoryUI:
    def __init__(self, ui, player, mini_map, info_ui, assets, keyboard, mouse):
        ...
        self.box_highlight_surf = pg.Surface((self.box_len, self.box_len))
        self.box_highlight_surf.fill(pg.Color(self.surf_color)[:3] + pg.Vector3(10,10,10))
        self.box_highlight_surf.set_alpha(self.surf_open.get_alpha())
    ...
    def check_mouse_overlap(self):
        ...
        if self.rect.collidepoint(mx, my):
            grid_x = mx // self.box_len
            grid_y = (my - self.rect.top) // self.box_len
